...
public class CanvasGame extends CandroidActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//                Log.d(CandroidActivity.LOGTAG, "Free Memory: "+r.freeMemory());
		//                Log.d(CandroidActivity.LOGTAG, "Total Memory: "+r.totalMemory());
		//                Log.d(CandroidActivity.LOGTAG, "Max Memory: "+r.maxMemory());
		
		setContentView(R.layout.main);
		
		gc = new GlobalClient(this, "10.0.0.1", 4445, 4444,false);
		gc.start();
